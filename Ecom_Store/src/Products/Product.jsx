...
<>
    <section className='flex flex-wrap gap-6 justify-center mt-[5rem]'>
        {data.map((product) => (
        <div key={Math.random()}
            className="w-[280px] h-[400px] bg-white rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 mt-6 border-t-4 border-blue-500">
                    ...
                    <div>
                        <div className="flex items-center justify-between ">
                            <div className="flex items-center gap-2">
                                    <span className="text-2xl font-bold relative bottom-4">{product.prevPrice}</span><span className="text-gray-600 line-through relative bottom-4 left-2">${product.newPrice}</span>
                            </div>
                        </div>
                        <div className="flex gap-15">
                            ...
                            <button
                                ...
                                <span className="material-symbols-outlined relative right-4 bottom-3"><FiShoppingCart /></span>
                            </button>
                        </div>
                    </div>
                </div>
